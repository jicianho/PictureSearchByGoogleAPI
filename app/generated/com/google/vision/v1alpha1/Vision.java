...
package com.google.vision.v1alpha1;

/**
 * Service definition for Vision (v1alpha1).
 *
 * <p>
 * The Google Cloud Vision API allows developers to easily integrate Google vision features, including the recognition of faces, landmarks, entities, text and explicit content, into applications.
 * </p>
 *
 * <p>
...
public class Vision extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.17.0-rc-SNAPSHOT of the Cloud Vision API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Images {
    ...
    /**
     * Run image annotation modules for a batch of images.
     *
     ...
     *
     * @param content the {@link com.google.vision.v1alpha1.model.BatchAnnotateImagesRequest}
     * @return the request
     */
    public Annotate annotate(com.google.vision.v1alpha1.model.BatchAnnotateImagesRequest content) throws java.io.IOException {
      Annotate result = new Annotate(content);
      initialize(result);
      return result;
    }

    public class Annotate extends VisionRequest<com.google.vision.v1alpha1.model.BatchAnnotateImagesResponse> {

      private static final String REST_PATH = "v1alpha1/images:annotate";
       ...
       * @since 1.13
       */
      protected Annotate(com.google.vision.v1alpha1.model.BatchAnnotateImagesRequest content) {
        super(Vision.this, "POST", REST_PATH, content, com.google.vision.v1alpha1.model.BatchAnnotateImagesResponse.class);
      }
